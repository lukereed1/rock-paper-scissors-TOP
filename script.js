...
function playRound() {
	...
	// Asks player for their choice and converts to lowercase. If user enters anything outside of the choices it asks them again. Quits if escape is pressed or user cancels
